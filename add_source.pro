...
; ==============================================================================
  pro ADD_SOURCE, parameters=p, name=name, directory=directory, satellite=satellite, $
    ...
    rep_shape=rep_shape,verbose=verbose,fmax_alt=fmax_alt,ssl=ssl
; ==============================================================================
; INPUTS :
...
; rep_lag: repete la simu avec diferentent valeurs de lag
; rep_shape: repete la simu avec diferentent valeurs de shape
; ssl: "shape sur lag" si =/= 0 alors shape=shape+ssl*lag
; ==============================================================================
...
for i0=0,rep_lag[0]-1 do for j0=0,rep_shape[0]-1 do begin
  ...
  (*p.src.data)(isrc0+2*j0+2*i0*rep_shape[0]:isrc0+1+2*j0+2*i0*rep_shape[0]).shape_cone     = shape+rep_shape[1]*j0+rep_lag[1]*i0*ssl
endfor
