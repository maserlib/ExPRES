...
;  SET_SIMULATION_TIME, simul_length=480., simul_step=1, parameters=params
...
ADD_SOURCE, name="Ovale Nord", directory="OvaleN", active_LO=[0,360,3],verbose=verbose,parameters=params,cone_app=70., cone_wid=.2, shape=0.2;,/gradb_test;,/intensity
ADD_SOURCE, name="Ovale Sud",  directory="OvaleS", active_LO=[0,360,3],verbose=verbose,parameters=params,cone_app=70., cone_wid=.2, shape=0.2;,/gradb_test;,/intensity
...
ADD_SOURCE, name="Io Flux Tube", directory="IFT", /satellite, pos_t0=[5.95, 105.], lag=[30.,-30.], shape=[0.1,0.1], cone_app=[70.,70.], cone_wid=[.2,.2], parameters=params,verbose=verbose,pole=[1,-1];,/gradb_test;,/intensity
