...
;  SET_OBSERVER, name="fixe", motion=0b, obs_params=[3000.,0.,351.], parameters=params
...
; SET_NEW_SOURCE, "Ganymede Flux Tube","GFT", sat=[15.1,0.]
 ...
 ADD_SOURCE, name="Io Flux Tube", directory="IFT", /satellite, pos_t0=[5.95, 15.], lag=[30.,-30.], shape=[0.1,0.1], cone_app=[70.,70.], cone_wid=[1.,1.], parameters=params
