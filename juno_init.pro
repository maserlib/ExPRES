...
;  SET_OBSERVER, name="fixe", motion=0b, obs_params=[3000.,0.,119.], parameters=params
  ...
  SET_OBSERVER, name="orbiter", motion=1b, obs_params=[20.31,6.5,119.,90.,0.,90.], parameters=params,verbose=verbose
;  SET_OBSERVER, name="orbiter", motion=1b, obs_params=[20.31,6.5,351.,90.,0.,90.], parameters=params,verbose=verbose
...
SET_OUTPUT,path='../',/latitude,/radius,/local_time,/kHz,/log,parameters=params
 SET_FREQUENCY, fmin=.1, fmax=40., fstep=0.1, parameters=params
;  SET_FREQUENCY, fmin=1., fmax=40., fstep=0.2,  parameters=params

 SET_DENSITY,[2E4,0.02,0],parameters=params
 SET_DENSITY,[1250.,0.9,1],parameters=params
 SET_DENSITY,[10.,0.,0],parameters=params
;
; ==============================================================================
