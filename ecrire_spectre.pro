...
; ------------------------------------------------------------------------------------
  pro ECRIRE_SPECTRE, spdyn, debt, dureet, y, path,freq_log=freq_log
; ------------------------------------------------------------------------------------
 sz = size(spdyn)
  ...
  if keyword_set(freq_log) then CONTOUR, ds, x, y, title='spectre dynamique', xtitle='temp en minutes', $
	ytitle='f (MHz)', /NODATA, xra=[debt,debt+dureet], yra=[fmin,fmax], $
	xsty=1, ysty=1, /ylog else CONTOUR, ds, x, y, title='spectre dynamique', xtitle='temp en minutes', $
	ytitle='f (MHz)', /NODATA, xra=[debt,debt+dureet], yra=[fmin,fmax], $
	xsty=1, ysty=1
